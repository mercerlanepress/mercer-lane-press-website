...
export const authors: Author[] = [
  ...
  { slug: 'sophie-ardenwood', name: 'Sophie Ardenwood', bio: 'Sophie Ardenwood writes practical dog-focused guides for Mercer Lane Press. Her books include The Reactive Dog Walking Playbook, Busy Dog, Better Day, and Dog Enrichment for Apartments & Busy Owners, covering reward-based walking systems and everyday enrichment for real homes and routines.', sameAs: 'https://www.amazon.com/s/ref=dp_byline_sr_book_1?ie=UTF8&field-author=Sophie+Ardenwood&text=Sophie+Ardenwood&sort=relevancerank&search-alias=books' }
];
